package com.toyshouse.controller;
...
public class PostController {
	...
	public String showPost(Model model) {
		String returnValue = "views/list";

		model.addAttribute("pageTitle", "toyshouse");
		model.addAttribute("posts", createPost());
	...
	public List<Post> createPost() {
		...
		// create an interface to do this
		Post post1 = new Post("Blog Post 1", new Date(), getPostBody(), "Okosun Promise Salisu");
		Post post2 = new Post("Blog Post 2", new Date(), "<p>This post didn't take long to write.</p>", "Daniel Thomas");
